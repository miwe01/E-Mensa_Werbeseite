...
<?php
    ...
    $sql = "SELECT bbg.id as Bewertungsid, bbg.Sternbewertung, bbg.Bemerkung, bbg.Hervorgehoben, g.name as gerichtname
    ...
    echo "<table><tr> <th>Gericht</th><th>Bewertung</th><th>Bemerkung</th><th>Löschen</th></tr>";
    while ($row = mysqli_fetch_assoc($result)) {
        if ($row['Hervorgehoben'] == 1){
            ...
            /* Lösch vorgang */
            echo '<td>
                        <b><a href="/meinebewertungen?delete=true&bewertungid= ' . $row['Bewertungsid'] . ' ">
                    Löschen
                    </a></b>
                </td>
                </tr>';
